            ...
            if (typeof (year) == "number") {
                function reqListener() {
                    ...
                    for (var i = 0; i < sites.length; i++) {
                        ...
                        if (b == 0) {
                            //设置偶数行的背景色
                            html = "<tr bgcolor='#bed1f2'><td>" + index + "</td><td>" + sites[i] + "</td>" + locate_Html + "<td>" + aod[i] + "</td></tr > ";
                        }
                        else if (b == 1) {
                            html = "<tr bgcolor=><td>" + index + "</td><td>" + sites[i] + "</td>" + locate_Html + "<td>" + aod[i] + "</td></tr>";
                        }
                        $("#aodTable table tbody").append(html);
                    }
                    //设置表格的padding
                    $("#aodTable table tbody tr td").css({ "padding": "5px 10px 5px 10px", "color": "#4d4d4d" });
                }
